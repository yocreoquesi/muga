...
MUGA also offers an optional way to support its independent developer at no extra cost to you. It is off by default, and you decide if and when to turn it on.
