...
| [0004](./0004-decommission-unwrap-server-native-shortener-resolution.md) | Decommission `unwrap.muga.app`, native shortener resolution | 2026-05-27 | Implemented |
...
| [0009](./0009-connect-src-wildcard.md) | `connect-src` stays permissive, because enumerating it cannot work | 2026-09-09 | Accepted |
| [0010](./0010-path-scoped-param-rules.md) | Path-scoped param rules — a literal path-prefix predicate for `domain-rules.json` | 2026-09-10 | Accepted |
| [0011](./0011-popup-glance-and-act.md) | The popup is "glance + act" — what it carries, and every pref classified | 2026-09-12 | Accepted |
