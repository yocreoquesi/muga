...
export default Object.freeze({
  ...
  ob_affiliate_desc: "<strong>クリエイターが最優先です。</strong>クリエイターのアフィリエイトタグがすでにリンクにある場合、MUGAはできるだけ触れないようにします。クリックを獲得した人がそれを保持できるようにするためです。あなたが主導権を握ります。すべてのアフィリエイトタグを削除するようMUGAに求めれば、そうします。<br><br>アフィリエイトタグが<strong>まったくない</strong>リンクの対象ストアでは、MUGAが当方のタグを追加できます。<strong>価格は変わりません。</strong>コードはオープンソースなので、何が起きるかを正確に確認できます。<br><br>アフィリエイトの帰属には2つの形があります。一部のプログラムはクリエイターのタグを店舗のURLに付け、他はアフィリエイトネットワーク経由でクリックをルーティングします。MUGAは両方を尊重するよう努めます。",
  ...
  ob_affiliate_check_label: "アフィリエイトタグがないリンクでMUGAのタグを許可",
  ob_affiliate_check_hint: "価格は常に同じです。リンクにすでにタグがある場合、削除を求めない限り、MUGAはできるだけ触れないようにします。ソースコードで確認してください。",
