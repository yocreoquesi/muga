...
export const TRANSLATIONS = {
  ...
  ob_feat1_title:           { en: "Strips 454 tracking parameters automatically",                             es: "Elimina 454 par\u00e1metros de rastreo autom\u00e1ticamente" },
  ...
  ob_feat5_title:           { en: "Right-click → Copy clean link or selection",                               es: "Clic derecho → Copiar enlace o selección limpia" },
  ob_feat5_desc:            { en: "Copies cleaned URLs to your clipboard. Works on a single link or a text selection with multiple URLs. No navigation needed.", es: "Copia las URLs limpias al portapapeles. Funciona con un enlace o una selección con varias URLs. Sin necesidad de navegar." },
  ob_step2_title:           { en: "Support an indie developer: your choice",                                 es: "Apoya al desarrollador: tú decides" },
  ob_affiliate_desc:        { en: 'When you visit a supported store (Amazon, eBay, Booking.com) and the link has <strong>no affiliate tag at all</strong>, MUGA can silently add ours. <strong>The price you pay is always identical.</strong> Affiliate tags don\u2019t affect what you pay, they tell the store who referred you. We earn a small commission.<br><br>This is how an independent developer earns income from the tool he maintains.', es: 'Cuando visitas una tienda compatible (Amazon, eBay, Booking.com) y el enlace <strong>no tiene ning\u00fan tag de afiliado</strong>, MUGA puede a\u00f1adir el nuestro silenciosamente. <strong>El precio que pagas es siempre el mismo.</strong> Los tags de afiliado no afectan lo que pagas, solo indican a la tienda qui\u00e9n te refiri\u00f3. Nosotros ganamos una peque\u00f1a comisi\u00f3n.<br><br>As\u00ed es como un desarrollador independiente obtiene ingresos de la herramienta que mantiene.' },
  ob_disclaimer:            { en: '<strong>What MUGA does not do by default:</strong> replace or overwrite a tag that is already in a link. If a creator\u2019s or another affiliate\u2019s tag is there, MUGA leaves it alone. By default, we never touch what isn\u2019t ours. MUGA only acts on links that have <em>no tag at all</em>. The source code is public. You can verify this yourself.', es: '<strong>Lo que MUGA no hace por defecto:</strong> reemplazar o sobreescribir un tag que ya existe en un enlace. Si el tag de un creador u otro afiliado ya est\u00e1 ah\u00ed, MUGA lo deja intacto. Por defecto, nunca tocamos lo que no es nuestro. MUGA solo act\u00faa en enlaces que <em>no tienen ning\u00fan tag</em>. El c\u00f3digo fuente es p\u00fablico. Puedes comprobarlo t\u00fa mismo.' },
