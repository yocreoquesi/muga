...
export const TRANSLATIONS = {
  ...
  ob_feat1_title:           { en: "Strips 435 tracking parameters automatically",                             es: "Elimina 435 par\u00e1metros de rastreo autom\u00e1ticamente" },
  ...
  ob_disclaimer:            { en: '<strong>What MUGA never does:</strong> replace or overwrite a tag that is already in a link. If a creator\u2019s or another affiliate\u2019s tag is there, MUGA leaves it alone. We never touch what isn\u2019t ours. MUGA only acts on links that have <em>no tag at all</em>. The source code is public \u2014 you can verify this yourself.', es: '<strong>Lo que MUGA nunca hace:</strong> reemplazar o sobreescribir un tag que ya existe en un enlace. Si el tag de un creador u otro afiliado ya est\u00e1 ah\u00ed, MUGA lo deja intacto. Nunca tocamos lo que no es nuestro. MUGA solo act\u00faa en enlaces que <em>no tienen ning\u00fan tag</em>. El c\u00f3digo fuente es p\u00fablico \u2014 puedes comprobarlo t\u00fa mismo.' },
