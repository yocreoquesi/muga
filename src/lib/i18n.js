...
export const TRANSLATIONS = {
  ...
  import_params_skipped: { en: "Settings imported. {n} custom param(s) skipped — too long, invalid format, or protected key.", es: "Ajustes importados. {n} parámetro(s) personalizado(s) omitido(s) — demasiado largo, formato inválido o clave protegida.", pt: "Configurações importadas. {n} parâmetro(s) personalizado(s) ignorado(s) — muito longo, formato inválido ou chave protegida.", de: "Einstellungen importiert. {n} benutzerdefinierter Parameter übersprungen — zu lang, ungültiges Format oder geschützter Schlüssel.", fr: "Paramètres importés. {n} paramètre(s) personnalisé(s) ignoré(s) — trop long, format invalide ou clé protégée.", it: "Impostazioni importate. {n} parametro/i personalizzato/i ignorato/i — troppo lungo, formato non valido o chiave protetta.", ja: "設定をインポートしました。{n}個のカスタムパラメータをスキップしました — 長すぎる、無効な形式、または保護されたキー。" },
  ...
  store_group_toggle:             { en: "Toggle {name} stores", es: "Alternar tiendas de {name}", pt: "Alternar lojas de {name}", de: "{name}-Shops umschalten", fr: "Basculer les boutiques {name}", it: "Attiva/disattiva i negozi {name}", ja: "{name}ストアの表示を切り替え" },
  ...
  exp_param_classes_warn: {
    ...
    es: "Puede romper algunos sitios. Desactívalo si ves problemas.",
  ...
  ob_success_msg:       { en: "MUGA is now active. You can close this tab.",     es: "MUGA ya está activo. Puedes cerrar esta pestaña.",          pt: "O MUGA já está ativo. Você pode fechar esta aba.",       de: "MUGA ist jetzt aktiv. Du kannst diesen Tab schließen.", fr: "MUGA est maintenant actif. Vous pouvez fermer cet onglet.", it: "MUGA è ora attivo. Puoi chiudere questa scheda.", ja: "MUGAが有効になりました。このタブを閉じることができます。" },
  ...
  ob_tagline:               { en: "The web, with the noise turned down.",                                                    es: "La web, con el ruido apagado.",                                                    pt: "A web, com o ruído desligado.",                                                    de: "Das Web, mit dem Rauschen abgedreht.", fr: "Le web, avec le bruit coupé.", it: "Il web, con il rumore spento.", ja: "ウェブ、ノイズを消した状態で。" },  ob_tagline_sub:           { en: "Denoise the web · honour creator referrals · zero telemetry.",     es: "Quita el ruido de la web · honra las referencias de creadores · cero telemetría.", pt: "Tira o ruído da web · honra as referências de criadores · zero telemetria.",  de: "Web entrauschen · Creator-Empfehlungen ehren · keine Telemetrie.",     fr: "Désencombrer le web · honorer les référents des créateurs · zéro télémétrie.", it: "Togli il rumore dal web · onora i referral dei creator · zero telemetria.", ja: "ウェブのノイズを除去 · クリエイターの紹介を尊重 · テレメトリーゼロ。" },
  ...
  migration_counter:  { en: "{n} of {total}",                                                                  es: "{n} de {total}",                                                                  pt: "{n} de {total}",                                                                    de: "{n} von {total}", fr: "{n} sur {total}", it: "{n} di {total}", ja: "{total}件中{n}件" },  ob_browser_sync_note: {
    ...
    es: "MUGA nunca envía datos a ningún sitio. Si tienes activada la sincronización del navegador, tus preferencias se sincronizan a través del navegador (Google para Chrome, Cuentas Firefox para Firefox) — es una función del navegador, no de MUGA.",
  ...
  follow_shorteners_section_title: {
    ...
    es: "Seguir redirecciones de acortadores",
    pt: "Seguir redirecionamentos de encurtadores",
    de: "Kurz-URL-Weiterleitungen folgen",
    fr: "Suivre les redirections des raccourcisseurs",
    it: "Segui i reindirizzamenti degli abbreviatori",
    ja: "短縮URLのリダイレクトをたどる",
  },
  follow_shorteners_enabled: {
    en: "Resolve shorteners in my browser",
    es: "Resolver acortadores en mi navegador",
    pt: "Resolver encurtadores no meu navegador",
    de: "Kurz-URLs in meinem Browser auflösen",
    fr: "Résoudre les raccourcisseurs dans mon navigateur",
    it: "Risolvi gli abbreviatori nel mio browser",
    ja: "ブラウザで短縮URLを解決する",
  },
  enable_follow_shorteners_cta: {
    en: "Resolve shorteners in my browser",
    es: "Resolver acortadores en mi navegador",
    pt: "Resolver encurtadores no meu navegador",
    de: "Kurz-URLs in meinem Browser auflösen",
  ...
  shortener_stats_label: {
    en: "Shortener resolution stats (beta)",
    es: "Estadísticas de resolución de acortadores (beta)",
    pt: "Estatísticas de resolução de encurtadores (beta)",
    de: "Auflösungsstatistiken für Kurz-URLs (Beta)",
    fr: "Statistiques de résolution des raccourcisseurs (bêta)",
    it: "Statistiche di risoluzione degli abbreviatori (beta)",
    ja: "短縮URL解決統計（ベータ）",
  },
  shortener_stats_hint: {
    en: "Pass/fail counts for native shortener resolution since last reset. Never transmitted.",
    es: "Conteos de éxito/fallo para la resolución nativa de acortadores desde el último reinicio. Nunca se transmiten.",
    pt: "Contagens de sucesso/falha para a resolução nativa de encurtadores desde a última redefinição. Nunca transmitidas.",
    de: "Erfolgs-/Fehlerzählungen für die native Auflösung von Kurz-URLs seit dem letzten Zurücksetzen. Werden nie übertragen.",
    fr: "Comptages réussi/échec pour la résolution native des raccourcisseurs depuis la dernière réinitialisation. Jamais transmis.",
    it: "Conteggi successo/fallimento per la risoluzione nativa degli abbreviatori dall'ultimo reset. Mai trasmessi.",
    ja: "前回リセット以降のネイティブ短縮URL解決の成功/失敗カウント。送信されません。",
  },
  shortener_stats_pass: {
    en: "pass",
    es: "éxito",
    pt: "sucesso",
    de: "Erfolg",
  ...
  shortener_stats_reset: {
    en: "Reset counters",
    es: "Reiniciar contadores",
    pt: "Redefinir contadores",
    de: "Zähler zurücksetzen",
    fr: "Réinitialiser les compteurs",
    it: "Azzera i contatori",
    ja: "カウンターをリセット",
  },
  mode_strict_local: {
    en: 'Strict Local',
