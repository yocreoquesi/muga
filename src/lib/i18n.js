...
export const TRANSLATIONS = {
  ...
  stat_junk:       { en: "tracking params removed", es: "parámetros eliminados", pt: "parâmetros removidos", de: "Tracking-Parameter entfernt", fr: "paramètres de pistage supprimés", it: "parametri di tracciamento rimossi", ja: "削除したトラッキングパラメータ" },
  ...
  history_copy_original: { en: "Copy with tracking", es: "Copiar con rastreo", pt: "Copiar com rastreamento", de: "Mit Tracking kopieren", fr: "Copier avec le pistage", it: "Copia con tracciamento", ja: "トラッキング付きでコピー" },
  ...
  domain_stats_label:    { en: "Your top trackers", es: "Tus principales rastreadores", pt: "Seus principais rastreadores", de: "Deine häufigsten Tracker", fr: "Vos principaux traqueurs", it: "I tuoi tracker principali", ja: "上位のトラッカー" },
  ...
  milestone_1000:  { en: "MUGA: Tracking Terminator", es: "MUGA: Exterminador de rastreo", pt: "MUGA: Exterminador de rastreamento", de: "MUGA: Tracking-Terminator", fr: "MUGA : Exterminateur de pistage", it: "MUGA: Sterminatore di tracker", ja: "MUGA: トラッキングターミネーター" },
  ...
  milestone_100:   { en: "MUGA: Making URLs Good Again", es: "MUGA: Haciendo las URLs geniales de nuevo", pt: "MUGA: Making URLs Good Again", de: "MUGA: Making URLs Good Again", fr: "MUGA : Making URLs Good Again", it: "MUGA: Making URLs Good Again", ja: "MUGA: URLを再び素晴らしく" },
  ...
  opts_subtitle:   { en: "Fair to every click.", es: "Justa con cada clic.", pt: "Justa com cada clique.", de: "Fair bei jedem Klick.", fr: "Équitable à chaque clic.", it: "Equa a ogni clic.", ja: "すべてのクリックに公平。" },
  ...
  row_dnr_label:         { en: "Strip tracking parameters before navigation", es: "Eliminar parámetros de rastreo antes de navegar", pt: "Remover parâmetros de rastreamento antes de navegar", de: "Tracking-Parameter vor der Navigation entfernen", fr: "Supprimer les paramètres de pistage avant la navigation", it: "Rimuovi i parametri di tracciamento prima della navigazione", ja: "ナビゲーション前にトラッキングパラメータを削除" },
  ...
  row_pings_label:       { en: "Block <a ping> tracking beacons",    es: "Bloquear balizas de rastreo <a ping>",    pt: "Bloquear balizas de rastreamento <a ping>",    de: "<a ping>-Tracking-Beacons blockieren", fr: "Bloquer les balises de pistage <a ping>", it: "Blocca i beacon di tracciamento <a ping>", ja: "<a ping>トラッキングビーコンをブロック" },
  ...
  row_amp_label:         { en: "Redirect AMP pages to canonical URL", es: "Redirigir páginas AMP a la URL canónica", pt: "Redirecionar páginas AMP para a URL canônica", de: "AMP-Seiten zur kanonischen URL weiterleiten", fr: "Rediriger les pages AMP vers l'URL canonique", it: "Reindirizza le pagine AMP all'URL canonico", ja: "AMPページを正規URLにリダイレクト" },
  ...
  row_toast_duration_label: { en: "Affiliate notification duration", es: "Duración de la notificación de afiliado", pt: "Duração da notificação de afiliado", de: "Anzeigedauer der Affiliate-Benachrichtigung", fr: "Durée de la notification d'affiliation", it: "Durata della notifica di affiliazione", ja: "アフィリエイト通知の表示時間" },
  ...
  optionsRemoteRulesTitle:        { en: "Remote rule updates",                                                                                                es: "Actualización remota de reglas",                           pt: "Atualizações remotas de regras" /* FIXME: needs native speaker review */,              de: "Remote-Regelaktualisierungen" /* FIXME: needs native speaker review */, fr: "Mises à jour de règles à distance", it: "Aggiornamenti remoti delle regole", ja: "ルールのリモート更新" },
  optionsRemoteRulesDesc:         { en: "Optional. Download weekly updates to the list of tracking parameters. Off by default.",                             es: "Opcional. Descarga actualizaciones semanales de la lista de parámetros de rastreo. Desactivado por defecto.",  pt: "Opcional. Baixa atualizações semanais da lista de parâmetros de rastreamento. Desativado por padrão." /* FIXME: needs native speaker review */,  de: "Optional. Lädt wöchentliche Aktualisierungen der Tracking-Parameter-Liste herunter. Standardmäßig deaktiviert." /* FIXME: needs native speaker review */, fr: "Facultatif. Télécharge des mises à jour hebdomadaires de la liste des paramètres de pistage. Désactivé par défaut.", it: "Opzionale. Scarica aggiornamenti settimanali dell'elenco dei parametri di tracciamento. Disattivato per impostazione predefinita.", ja: "オプション。トラッキングパラメータリストの週次更新をダウンロードします。デフォルトでオフ。" },
  optionsRemoteRulesToggle:       { en: "Enable weekly updates",                                                                                             es: "Activar actualizaciones semanales",                         pt: "Ativar atualizações semanais" /* FIXME: needs native speaker review */,                de: "Wöchentliche Aktualisierungen aktivieren" /* FIXME: needs native speaker review */, fr: "Activer les mises à jour hebdomadaires", it: "Attiva aggiornamenti settimanali", ja: "週次更新を有効にする" },
  optionsRemoteRulesLastFetch:    { en: "Last checked:",                                                                                                     es: "Última comprobación:",                                      pt: "Última verificação:" /* FIXME: needs native speaker review */,                        de: "Zuletzt geprüft:" /* FIXME: needs native speaker review */, fr: "Dernière vérification :", it: "Ultima verifica:", ja: "最終確認:" },
  optionsRemoteRulesParamCount:   { en: "Active remote params:",                                                                                             es: "Parámetros remotos activos:",                               pt: "Parâmetros remotos ativos:" /* FIXME: needs native speaker review */,                 de: "Aktive Remote-Parameter:" /* FIXME: needs native speaker review */, fr: "Paramètres distants actifs :", it: "Parametri remoti attivi:", ja: "アクティブなリモートパラメータ:" },
  optionsRemoteRulesSource:       { en: "Source",                                                                                                            es: "Fuente",                                                    pt: "Fonte" /* FIXME: needs native speaker review */,                                      de: "Quelle" /* FIXME: needs native speaker review */, fr: "Source", it: "Origine", ja: "ソース" },
  optionsRemoteRulesError:        { en: "Update failed. Check the console for details.",                                                                     es: "La actualización falló. Consulta la consola para más detalles.", pt: "Atualização falhou. Verifique o console para detalhes." /* FIXME: needs native speaker review */, de: "Aktualisierung fehlgeschlagen. Details in der Konsole." /* FIXME: needs native speaker review */, fr: "Échec de la mise à jour. Consultez la console pour plus de détails.", it: "Aggiornamento fallito. Controlla la console per i dettagli.", ja: "更新に失敗しました。詳細はコンソールを確認してください。" },
  optionsRemoteRulesNeverFetched: { en: "Never checked.",                                                                                                    es: "Nunca comprobado.",                                         pt: "Nunca verificado." /* FIXME: needs native speaker review */,                          de: "Nie geprüft." /* FIXME: needs native speaker review */, fr: "Jamais vérifié.", it: "Mai verificato.", ja: "未確認。" },
  optionsRemoteRulesPermDenied:   { en: "Permission was not granted. Updates remain off.",                                                                   es: "Permiso no concedido. Las actualizaciones siguen desactivadas.", pt: "Permissão não concedida. Atualizações permanecem desativadas." /* FIXME: needs native speaker review */, de: "Berechtigung nicht erteilt. Aktualisierungen bleiben deaktiviert." /* FIXME: needs native speaker review */, fr: "Autorisation refusée. Les mises à jour restent désactivées.", it: "Permesso non concesso. Gli aggiornamenti rimangono disattivati.", ja: "権限が付与されませんでした。更新はオフのままです。" },
  optionsRemoteRulesErrNetwork:   { en: "Could not reach the update server. Previous list still in use.",                                                    es: "No se pudo contactar con el servidor. Se sigue usando la lista anterior.", pt: "Não foi possível contactar o servidor de atualização. A lista anterior ainda está em uso." /* FIXME: needs native speaker review */, de: "Update-Server nicht erreichbar. Vorherige Liste wird weiterhin verwendet." /* FIXME: needs native speaker review */, fr: "Impossible de joindre le serveur de mise à jour. La liste précédente reste utilisée.", it: "Impossibile raggiungere il server di aggiornamento. L'elenco precedente è ancora in uso.", ja: "更新サーバーに到達できませんでした。以前のリストを引き続き使用します。" },
  optionsRemoteRulesErrSchema:    { en: "Update file was malformed.",                                                                                        es: "El archivo de actualización estaba mal formado.",           pt: "Arquivo de atualização malformado." /* FIXME: needs native speaker review */,            de: "Aktualisierungsdatei war fehlerhaft." /* FIXME: needs native speaker review */, fr: "Le fichier de mise à jour était mal formé.", it: "Il file di aggiornamento era malformato.", ja: "更新ファイルの形式が不正でした。" },
  optionsRemoteRulesErrSignature: { en: "Update signature did not match. Update ignored.",                                                                   es: "La firma de la actualización no coincide. Actualización ignorada.", pt: "Assinatura de atualização não correspondeu. Atualização ignorada." /* FIXME: needs native speaker review */, de: "Aktualisierungssignatur stimmte nicht überein. Aktualisierung ignoriert." /* FIXME: needs native speaker review */, fr: "La signature de la mise à jour ne correspond pas. Mise à jour ignorée.", it: "La firma dell'aggiornamento non corrisponde. Aggiornamento ignorato.", ja: "更新の署名が一致しませんでした。更新を無視しました。" },
  optionsRemoteRulesErrFormat:    { en: "Update contained an invalid parameter. Ignored.",                                                                   es: "La actualización contenía un parámetro inválido. Ignorada.", pt: "Atualização continha um parâmetro inválido. Ignorada." /* FIXME: needs native speaker review */, de: "Aktualisierung enthielt einen ungültigen Parameter. Ignoriert." /* FIXME: needs native speaker review */, fr: "La mise à jour contenait un paramètre invalide. Ignorée.", it: "L'aggiornamento conteneva un parametro non valido. Ignorato.", ja: "更新に無効なパラメータが含まれていました。無視しました。" },
  optionsRemoteRulesErrDenylist:  { en: "Update contained a reserved parameter. Ignored.",                                                                   es: "La actualización contenía un parámetro reservado. Ignorada.", pt: "Atualização continha um parâmetro reservado. Ignorada." /* FIXME: needs native speaker review */, de: "Aktualisierung enthielt einen reservierten Parameter. Ignoriert." /* FIXME: needs native speaker review */, fr: "La mise à jour contenait un paramètre réservé. Ignorée.", it: "L'aggiornamento conteneva un parametro riservato. Ignorato.", ja: "更新に予約済みパラメータが含まれていました。無視しました。" },
  optionsRemoteRulesErrOverCap:   { en: "Update was too large. Ignored.",                                                                                    es: "La actualización era demasiado grande. Ignorada.",           pt: "Atualização era grande demais. Ignorada." /* FIXME: needs native speaker review */,      de: "Aktualisierung war zu groß. Ignoriert." /* FIXME: needs native speaker review */, fr: "La mise à jour était trop volumineuse. Ignorée.", it: "L'aggiornamento era troppo grande. Ignorato.", ja: "更新が大きすぎました。無視しました。" },
  optionsRemoteRulesErrVersion:   { en: "Update was older than current. Ignored.",                                                                           es: "La actualización era más antigua que la actual. Ignorada.", pt: "Atualização era mais antiga que a atual. Ignorada." /* FIXME: needs native speaker review */, de: "Aktualisierung war älter als die aktuelle. Ignoriert." /* FIXME: needs native speaker review */, fr: "La mise à jour était plus ancienne que la version actuelle. Ignorée.", it: "L'aggiornamento era più vecchio di quello attuale. Ignorato.", ja: "更新が現在のバージョンより古いものでした。無視しました。" },
  optionsRemoteRulesErrStale:     { en: "Update file was too old. Ignored.",                                                                                 es: "El archivo de actualización era demasiado antiguo. Ignorado.", pt: "Arquivo de atualização era muito antigo. Ignorado." /* FIXME: needs native speaker review */, de: "Aktualisierungsdatei war zu alt. Ignoriert." /* FIXME: needs native speaker review */, fr: "Le fichier de mise à jour était trop ancien. Ignoré.", it: "Il file di aggiornamento era troppo vecchio. Ignorato.", ja: "更新ファイルが古すぎました。無視しました。" },
  ...
  dev_url_clean:              { en: "No tracking params found. URL is already clean.",                   es: "Sin parámetros de rastreo. La URL ya está limpia.",                   pt: "Nenhum parâmetro de rastreamento encontrado. A URL já está limpa.",                   de: "Keine Tracking-Parameter gefunden. URL ist bereits sauber.", fr: "Aucun paramètre de pistage trouvé. L'URL est déjà propre.", it: "Nessun parametro di tracciamento trovato. L'URL è già pulito.", ja: "トラッキングパラメータは見つかりませんでした。URLはすでにクリーンです。" },
  ...
  preview_count_one:              { en: "MUGA removed 1 tracker from this URL",                            es: "MUGA eliminó 1 rastreador de esta URL",                              pt: "O MUGA removeu 1 rastreador desta URL",                              de: "MUGA hat 1 Tracker aus dieser URL entfernt", fr: "MUGA a supprimé 1 traqueur de cette URL", it: "MUGA ha rimosso 1 tracker da questo URL", ja: "MUGAはこのURLから1個のトラッカーを削除しました" },
  preview_count_other:            { en: "MUGA removed {n} trackers from this URL",                         es: "MUGA eliminó {n} rastreadores de esta URL",                          pt: "O MUGA removeu {n} rastreadores desta URL",                          de: "MUGA hat {n} Tracker aus dieser URL entfernt", fr: "MUGA a supprimé {n} traqueurs de cette URL", it: "MUGA ha rimosso {n} tracker da questo URL", ja: "MUGAはこのURLから{n}個のトラッカーを削除しました" },
  ...
  ob_success_title:     { en: "You're all set",                                  es: "Todo listo",                                                pt: "Tudo pronto",                                            de: "Alles erledigt", fr: "Tout est prêt", it: "È tutto pronto", ja: "準備完了" },
  ...
  tooltip_cleaned:                { en: "MUGA — tracking removed",                               es: "MUGA — rastreo eliminado",                              pt: "MUGA — rastreamento removido",                          de: "MUGA — Tracking entfernt", fr: "MUGA — pistage supprimé", it: "MUGA — tracciamento rimosso", ja: "MUGA — トラッキングを削除" },
  ...
  ob_tagline:               { en: "Fair to every click.", es: "Justa con cada clic.", pt: "Justa com cada clique.", de: "Fair bei jedem Klick.", fr: "Équitable à chaque clic.", it: "Equa a ogni clic.", ja: "すべてのクリックに公平。" },  ob_tagline_sub:           { en: "No servers. No telemetry. URLs never leave your browser.", es: "Sin servidores. Sin telemetría. Las URLs nunca salen de tu navegador.", pt: "Sem servidores. Sem telemetria. As URLs nunca saem do seu navegador.", de: "Keine Server. Keine Telemetrie. URLs verlassen nie deinen Browser.", fr: "Pas de serveurs. Pas de télémétrie. Les URL ne quittent jamais votre navigateur.", it: "Nessun server. Nessuna telemetria. Gli URL non lasciano mai il tuo browser.", ja: "サーバーなし。テレメトリなし。URLはブラウザを離れません。" },
  ob_step1_title:           { en: "What MUGA does, automatically", es: "Lo que MUGA hace, automáticamente", pt: "O que MUGA faz, automaticamente", de: "Was MUGA automatisch macht", fr: "Ce que MUGA fait, automatiquement", it: "Cosa fa MUGA, automaticamente", ja: "MUGAが自動的に行うこと" },
  ob_feat1_title:           { en: "Strips 450+ tracking parameters from every URL", es: "Elimina 450+ parámetros de rastreo de cada URL", pt: "Remove 450+ parâmetros de rastreamento de cada URL", de: "Entfernt 450+ Tracking-Parameter aus jeder URL", fr: "Supprime plus de 450 paramètres de pistage de chaque URL", it: "Rimuove oltre 450 parametri di tracciamento da ogni URL", ja: "すべてのURLから450以上のトラッキングパラメータを削除" },
  ob_feat1_desc:            { en: "fbclid, gclid, UTMs, and hundreds more. Removed before the page loads. No data is collected or sent anywhere.", es: "fbclid, gclid, UTMs y cientos más. Eliminados antes de que cargue la página. No se recoge ni envía ningún dato.", pt: "fbclid, gclid, UTMs e centenas mais. Removidos antes de a página carregar. Nenhum dado é coletado ou enviado.", de: "fbclid, gclid, UTMs und Hunderte mehr. Vor dem Laden der Seite entfernt. Es werden keine Daten gesammelt oder gesendet.", fr: "fbclid, gclid, UTM et des centaines d'autres. Supprimés avant le chargement de la page. Aucune donnée n'est collectée ni envoyée.", it: "fbclid, gclid, UTM e centinaia di altri. Rimossi prima del caricamento della pagina. Nessun dato viene raccolto o inviato.", ja: "fbclid、gclid、UTM、その他数百種類。ページ読み込み前に削除されます。データは収集も送信もされません。" },
  ob_feat2_title:           { en: "Blocks hidden tracking: AMP redirects, ping beacons, URL wrappers", es: "Bloquea rastreo oculto: redirecciones AMP, balizas ping, wrappers de URL", pt: "Bloqueia rastreamento oculto: redirecionamentos AMP, balizas ping, wrappers de URL", de: "Blockiert verstecktes Tracking: AMP-Weiterleitungen, Ping-Beacons, URL-Wrapper", fr: "Bloque le pistage caché : redirections AMP, balises ping, wrappers d'URL", it: "Blocca tracciamento nascosto: reindirizzamenti AMP, beacon ping, wrapper URL", ja: "隠れたトラッキングをブロック: AMPリダイレクト、pingビーコン、URLラッパー" },
  ob_feat2_desc:            { en: "Every trick advertisers use to follow your clicks is neutralized locally, inside your browser.", es: "Cada truco que los anunciantes usan para seguir tus clics se neutraliza en local, dentro de tu navegador.", pt: "Cada truque que os anunciantes usam para rastrear seus cliques é neutralizado localmente, dentro do seu navegador.", de: "Jeder Trick, den Werbetreibende nutzen, um deine Klicks zu verfolgen, wird lokal in deinem Browser neutralisiert.", fr: "Chaque astuce utilisée par les annonceurs pour suivre vos clics est neutralisée localement, dans votre navigateur.", it: "Ogni trucco usato dagli inserzionisti per seguire i tuoi clic viene neutralizzato localmente, nel tuo browser.", ja: "広告主があなたのクリックを追跡するために使うあらゆる手口を、ブラウザ内でローカルに無力化します。" },
  ...
  ob_cta_btn:               { en: "Start browsing clean", es: "Empieza a navegar limpio", pt: "Comece a navegar limpo", de: "Sauber surfen starten", fr: "Commencer à naviguer proprement", it: "Inizia a navigare in modo pulito", ja: "クリーンなブラウジングを開始" },
  ...
  migration_counter:  { en: "{n} of {total}", es: "{n} de {total}", pt: "{n} de {total}", de: "{n} von {total}", fr: "{n} sur {total}", it: "{n} di {total}", ja: "{total}件中{n}件" },  ob_cta_note:              { en: "Change any setting anytime.", es: "Cambia cualquier ajuste cuando quieras.", pt: "Altere qualquer configuração quando quiser.", de: "Jede Einstellung jederzeit änderbar.", fr: "Modifiez n'importe quel paramètre à tout moment.", it: "Cambia qualsiasi impostazione in qualsiasi momento.", ja: "いつでも設定を変更できます。" },
  ...
  privacy_proxy_enabled: {
    ...
    fr: 'Activer Privacy Proxy',
    it: 'Attiva Privacy Proxy',
    ja: 'Privacy Proxyを有効にする',
  },
  mode_strict_local: {
    en: 'Strict Local',
    es: 'Estricto Local',
  ...
  privacy_proxy_disclosure: {
    en: 'When Privacy Proxy is enabled, the full URL of unresolvable opaque redirector links (affiliate networks and generic shorteners such as bit.ly) is sent to unwrap.muga.app — a Cloudflare Worker operated by MUGA — to retrieve the final destination. Every response is verified with an Ed25519 digital signature before your browser navigates anywhere; a tampered response is rejected entirely. No browsing history is stored by the Worker. You can disable this feature at any time by toggling this switch off.',
    es: 'Cuando el Proxy de Privacidad está activado, la URL completa de los enlaces opacos irresolubles (redes de afiliados y acortadores genéricos como bit.ly) se envía a unwrap.muga.app — un Worker de Cloudflare operado por MUGA — para obtener el destino final. Cada respuesta se verifica con una firma digital Ed25519 antes de que el navegador abra cualquier página; una respuesta alterada se rechaza por completo. El Worker no almacena historial de navegación. Puedes desactivar esta función en cualquier momento usando este interruptor.',
    pt: 'FIXME: translate' /* FIXME: needs native speaker review */,
    de: 'FIXME: translate' /* FIXME: needs native speaker review */,
    fr: 'Lorsque Privacy Proxy est activé, l\'URL complète des liens de redirection opaques non résolvables (réseaux d\'affiliation et raccourcisseurs génériques comme bit.ly) est envoyée à unwrap.muga.app — un Cloudflare Worker exploité par MUGA — pour récupérer la destination finale. Chaque réponse est vérifiée par une signature numérique Ed25519 avant que votre navigateur ne navigue où que ce soit ; une réponse altérée est entièrement rejetée. Aucun historique de navigation n\'est stocké par le Worker. Vous pouvez désactiver cette fonctionnalité à tout moment en désactivant cet interrupteur.',
    it: 'Quando Privacy Proxy è attivo, l\'URL completo dei link di reindirizzamento opachi non risolvibili (reti di affiliazione e abbreviatori generici come bit.ly) viene inviato a unwrap.muga.app — un Cloudflare Worker gestito da MUGA — per recuperare la destinazione finale. Ogni risposta viene verificata con una firma digitale Ed25519 prima che il browser navighi ovunque; una risposta manomessa viene respinta interamente. Nessuna cronologia di navigazione viene memorizzata dal Worker. Puoi disattivare questa funzione in qualsiasi momento disattivando questo interruttore.',
    ja: 'Privacy Proxyが有効になっている場合、解決不可能な不透明なリダイレクタリンク (アフィリエイトネットワークやbit.lyなどの汎用短縮URL) の完全なURLが unwrap.muga.app — MUGAが運営するCloudflare Worker — に送信され、最終的な宛先を取得します。各レスポンスはブラウザがどこかに移動する前にEd25519デジタル署名で検証されます。改ざんされたレスポンスは完全に拒否されます。閲覧履歴はWorkerに保存されません。このスイッチをオフにすることでこの機能をいつでも無効にできます。',
  },
  ...
  proxy_auto_disabled: {
    ...
    pt: 'FIXME: translate' /* FIXME: needs native speaker review */,
    de: 'FIXME: translate' /* FIXME: needs native speaker review */,
    fr: 'Privacy Proxy désactivé automatiquement : l\'autorisation a été révoquée.',
    it: 'Privacy Proxy disattivato automaticamente: il permesso è stato revocato.',
    ja: 'Privacy Proxyを自動的に無効化しました: 権限が取り消されました。',
  },
