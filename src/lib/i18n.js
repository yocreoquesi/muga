...
export const TRANSLATIONS = {
  ...
  stat_junk:       { en: "bits of noise removed", es: "parámetros eliminados", pt: "parâmetros removidos", de: "Tracking-Parameter entfernt", fr: "paramètres de pistage supprimés", it: "parametri di tracciamento rimossi", ja: "削除したトラッキングパラメータ" },
  ...
  history_copy_original: { en: "Copy with noise", es: "Copiar con rastreo", pt: "Copiar com rastreamento", de: "Mit Tracking kopieren", fr: "Copier avec le pistage", it: "Copia con tracciamento", ja: "トラッキング付きでコピー" },
  ...
  domain_stats_label:    { en: "Where the most noise comes from", es: "Tus principales rastreadores", pt: "Seus principais rastreadores", de: "Deine häufigsten Tracker", fr: "Vos principaux traqueurs", it: "I tuoi tracker principali", ja: "上位のトラッカー" },
  ...
  milestone_1000:  { en: "MUGA: Noise Terminator", es: "MUGA: Exterminador de rastreo", pt: "MUGA: Exterminador de rastreamento", de: "MUGA: Tracking-Terminator", fr: "MUGA : Exterminateur de pistage", it: "MUGA: Sterminatore di tracker", ja: "MUGA: トラッキングターミネーター" },
  ...
  milestone_100:   { en: "MUGA: Noise level: low", es: "MUGA: Haciendo las URLs geniales de nuevo", pt: "MUGA: Making URLs Good Again", de: "MUGA: Making URLs Good Again", fr: "MUGA : Making URLs Good Again", it: "MUGA: Making URLs Good Again", ja: "MUGA: URLを再び素晴らしく" },
  ...
  opts_subtitle:   { en: "The denoise extension for the web.", es: "Justa con cada clic.", pt: "Justa com cada clique.", de: "Fair bei jedem Klick.", fr: "Équitable à chaque clic.", it: "Equa a ogni clic.", ja: "すべてのクリックに公平。" },
  ...
  row_pings_label:       { en: "Block <a ping> beacons",    es: "Bloquear balizas de rastreo <a ping>",    pt: "Bloquear balizas de rastreamento <a ping>",    de: "<a ping>-Tracking-Beacons blockieren", fr: "Bloquer les balises de pistage <a ping>", it: "Blocca i beacon di tracciamento <a ping>", ja: "<a ping>トラッキングビーコンをブロック" },
  ...
  row_amp_label:         { en: "Skip AMP detours", es: "Redirigir páginas AMP a la URL canónica", pt: "Redirecionar páginas AMP para a URL canônica", de: "AMP-Seiten zur kanonischen URL weiterleiten", fr: "Rediriger les pages AMP vers l'URL canonique", it: "Reindirizza le pagine AMP all'URL canonico", ja: "AMPページを正規URLにリダイレクト" },
  ...
  row_toast_duration_label: { en: "Toast duration when a creator tag is detected", es: "Duración de la notificación de afiliado", pt: "Duração da notificação de afiliado", de: "Anzeigedauer der Affiliate-Benachrichtigung", fr: "Durée de la notification d'affiliation", it: "Durata della notifica di affiliazione", ja: "アフィリエイト通知の表示時間" },
  ...
  dev_url_clean:              { en: "No noise here. URL is already clean.",                   es: "Sin parámetros de rastreo. La URL ya está limpia.",                   pt: "Nenhum parâmetro de rastreamento encontrado. A URL já está limpa.",                   de: "Keine Tracking-Parameter gefunden. URL ist bereits sauber.", fr: "Aucun paramètre de pistage trouvé. L'URL est déjà propre.", it: "Nessun parametro di tracciamento trovato. L'URL è già pulito.", ja: "トラッキングパラメータは見つかりませんでした。URLはすでにクリーンです。" },
  ...
  preview_count_one:              { en: "MUGA removed 1 bit of noise from this URL",                            es: "MUGA eliminó 1 rastreador de esta URL",                              pt: "O MUGA removeu 1 rastreador desta URL",                              de: "MUGA hat 1 Tracker aus dieser URL entfernt", fr: "MUGA a supprimé 1 traqueur de cette URL", it: "MUGA ha rimosso 1 tracker da questo URL", ja: "MUGAはこのURLから1個のトラッカーを削除しました" },
  preview_count_other:            { en: "MUGA removed {n} bits of noise from this URL",                         es: "MUGA eliminó {n} rastreadores de esta URL",                          pt: "O MUGA removeu {n} rastreadores desta URL",                          de: "MUGA hat {n} Tracker aus dieser URL entfernt", fr: "MUGA a supprimé {n} traqueurs de cette URL", it: "MUGA ha rimosso {n} tracker da questo URL", ja: "MUGAはこのURLから{n}個のトラッカーを削除しました" },
  ...
  ob_success_title:     { en: "You're set. The noise is off.",                                  es: "Todo listo",                                                pt: "Tudo pronto",                                            de: "Alles erledigt", fr: "Tout est prêt", it: "È tutto pronto", ja: "準備完了" },
  ...
  tooltip_cleaned:                { en: "MUGA — noise removed",                               es: "MUGA — rastreo eliminado",                              pt: "MUGA — rastreamento removido",                          de: "MUGA — Tracking entfernt", fr: "MUGA — pistage supprimé", it: "MUGA — tracciamento rimosso", ja: "MUGA — トラッキングを削除" },
  ...
  ob_cta_btn:               { en: "Turn the noise off",                                                   es: "Empieza a navegar limpio",                                                   pt: "Comece a navegar limpo",                                                   de: "Sauber surfen starten", fr: "Commencer à naviguer proprement", it: "Inizia a navigare in modo pulito", ja: "クリーンなブラウジングを開始" },
  ...
  privacy_proxy_enabled: {
    ...
    pt: 'Ativar Proxy de Privacidade',
    de: 'Privacy Proxy aktivieren',
  ...
  privacy_proxy_disclosure: {
    ...
    pt: 'Quando o Proxy de Privacidade está ativado, a URL completa de links redirecionadores opacos não resolvíveis (redes de afiliados e encurtadores genéricos como bit.ly) é enviada para unwrap.muga.app — um Worker da Cloudflare operado pelo MUGA — para obter o destino final. Toda resposta é verificada com uma assinatura digital Ed25519 antes de o navegador navegar para qualquer lugar; uma resposta adulterada é totalmente rejeitada. Nenhum histórico de navegação é armazenado pelo Worker. Você pode desativar este recurso a qualquer momento usando este interruptor.',
    de: 'Wenn der Privacy Proxy aktiviert ist, wird die vollständige URL nicht auflösbarer opaker Redirector-Links (Affiliate-Netzwerke und generische Kurz-URLs wie bit.ly) an unwrap.muga.app gesendet — einen von MUGA betriebenen Cloudflare Worker — um das endgültige Ziel zu ermitteln. Jede Antwort wird vor jeglicher Navigation mit einer digitalen Ed25519-Signatur überprüft; eine manipulierte Antwort wird vollständig abgelehnt. Der Worker speichert keinen Browserverlauf. Du kannst diese Funktion jederzeit über diesen Schalter deaktivieren.',
  ...
  proxy_auto_disabled: {
    ...
    pt: 'Proxy de Privacidade desativado automaticamente: a permissão foi revogada.',
    de: 'Privacy Proxy automatisch deaktiviert: Berechtigung wurde widerrufen.',
