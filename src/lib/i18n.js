...
export const TRANSLATIONS = {
  ...
  support_section_title: { en: "Support MUGA",                                                                                       es: "Apoyar MUGA",                                                                                            pt: "Apoiar o MUGA"                                                                                         , de: "MUGA unterstützen"                                                                                       },
  support_label:         { en: "Open source. No ads. No telemetry.",                                                                 es: "Código abierto. Sin anuncios. Sin telemetría.",                                                          pt: "Código aberto. Sem anúncios. Sem telemetria."                                                          , de: "Open source. Keine Werbung. Keine Telemetrie."                                                            },
  support_hint:          { en: "MUGA is free and ad-free. Affiliate revenue is small. If MUGA saves you time, consider supporting development. No tracking, no redirect — the link opens directly in a new tab.", es: "MUGA es gratis y sin publicidad. Los ingresos por afiliados son pequeños. Si MUGA te ahorra tiempo, considerá apoyar el desarrollo. Sin rastreo, sin redirecciones — el enlace abre directo en una pestaña nueva.", pt: "O MUGA é gratuito e sem anúncios. A receita de afiliados é pequena. Se o MUGA te poupa tempo, considere apoiar o desenvolvimento. Sem rastreamento, sem redirecionamento — o link abre direto em uma aba nova.", de: "MUGA ist kostenlos und werbefrei. Affiliate-Einnahmen sind gering. Wenn MUGA dir Zeit spart, erwäge, die Entwicklung zu unterstützen. Kein Tracking, keine Weiterleitung — der Link öffnet direkt in einem neuen Tab." },
  support_github_sponsors: { en: "GitHub Sponsors (recurring)",                                                                      es: "GitHub Sponsors (mensual)",                                                                              pt: "GitHub Sponsors (recorrente)"                                                                           , de: "GitHub Sponsors (wiederkehrend)"                                                                          },
  support_kofi:          { en: "Ko-fi (one-time)",                                                                                   es: "Ko-fi (una vez)",                                                                                        pt: "Ko-fi (pagamento único)", de: "Ko-fi (einmalig)"                                                                                         },
  support_link:          { en: "Support ♥",                                                                                          es: "Apoyar ♥",                                                                                                pt: "Apoiar ♥"                                                                                              , de: "Unterstützen ♥"                                                                                          },
  ...
  optionsRemoteRulesTitle:        { en: "Remote rule updates",                                                                                                es: "Actualización remota de reglas",                           pt: "Atualizações remotas de regras",              de: "Remote-Regelaktualisierungen" },
  ...
  optionsRemoteRulesToggle:       { en: "Enable weekly updates",                                                                                             es: "Activar actualizaciones semanales",                         pt: "Ativar atualizações semanais",                de: "Wöchentliche Aktualisierungen aktivieren" },
  optionsRemoteRulesLastFetch:    { en: "Last checked:",                                                                                                     es: "Última comprobación:",                                      pt: "Última verificação:",                        de: "Zuletzt geprüft:" },
  optionsRemoteRulesParamCount:   { en: "Active remote params:",                                                                                             es: "Parámetros remotos activos:",                               pt: "Parâmetros remotos ativos:",                 de: "Aktive Remote-Parameter:" },
  optionsRemoteRulesSource:       { en: "Source",                                                                                                            es: "Fuente",                                                    pt: "Fonte",                                      de: "Quelle" },
  optionsRemoteRulesError:        { en: "Update failed. Check the console for details.",                                                                     es: "La actualización falló. Consulta la consola para más detalles.", pt: "Atualização falhou. Verifique o console para detalhes.", de: "Aktualisierung fehlgeschlagen. Details in der Konsole." },
  optionsRemoteRulesNeverFetched: { en: "Never checked.",                                                                                                    es: "Nunca comprobado.",                                         pt: "Nunca verificado.",                          de: "Nie geprüft." },
  optionsRemoteRulesPermDenied:   { en: "Permission was not granted. Updates remain off.",                                                                   es: "Permiso no concedido. Las actualizaciones siguen desactivadas.", pt: "Permissão não concedida. Atualizações permanecem desativadas.", de: "Berechtigung nicht erteilt. Aktualisierungen bleiben deaktiviert." },
  ...
  optionsRemoteRulesErrSchema:    { en: "Update file was malformed.",                                                                                        es: "El archivo de actualización estaba mal formado.",           pt: "Arquivo de atualização malformado.",            de: "Aktualisierungsdatei war fehlerhaft." },
  optionsRemoteRulesErrSignature: { en: "Update signature did not match. Update ignored.",                                                                   es: "La firma de la actualización no coincide. Actualización ignorada.", pt: "Assinatura de atualização não correspondeu. Atualização ignorada.", de: "Aktualisierungssignatur stimmte nicht überein. Aktualisierung ignoriert." },
  optionsRemoteRulesErrFormat:    { en: "Update contained an invalid parameter. Ignored.",                                                                   es: "La actualización contenía un parámetro inválido. Ignorada.", pt: "Atualização continha um parâmetro inválido. Ignorada.", de: "Aktualisierung enthielt einen ungültigen Parameter. Ignoriert." },
  optionsRemoteRulesErrDenylist:  { en: "Update contained a reserved parameter. Ignored.",                                                                   es: "La actualización contenía un parámetro reservado. Ignorada.", pt: "Atualização continha um parâmetro reservado. Ignorada.", de: "Aktualisierung enthielt einen reservierten Parameter. Ignoriert." },
  optionsRemoteRulesErrOverCap:   { en: "Update was too large. Ignored.",                                                                                    es: "La actualización era demasiado grande. Ignorada.",           pt: "Atualização era grande demais. Ignorada.",      de: "Aktualisierung war zu groß. Ignoriert." },
  optionsRemoteRulesErrVersion:   { en: "Update was older than current. Ignored.",                                                                           es: "La actualización era más antigua que la actual. Ignorada.", pt: "Atualização era mais antiga que a atual. Ignorada.", de: "Aktualisierung war älter als die aktuelle. Ignoriert." },
  optionsRemoteRulesErrStale:     { en: "Update file was too old. Ignored.",                                                                                 es: "El archivo de actualización era demasiado antiguo. Ignorado.", pt: "Arquivo de atualização era muito antigo. Ignorado.", de: "Aktualisierungsdatei war zu alt. Ignoriert." },
  optionsRemoteRulesErrUnknown:   { en: "Update failed. Check the console for details.",                                                                     es: "La actualización falló. Consulta la consola para más detalles.", pt: "Atualização falhou. Verifique o console para detalhes.", de: "Aktualisierung fehlgeschlagen. Details in der Konsole." },
  ...
  muga_disabled_for_domain:       { en: "MUGA is disabled on this site",                                                                                     es: "MUGA está desactivado en este sitio",                       pt: "MUGA está desativado neste site",             de: "MUGA ist auf dieser Seite deaktiviert" },
  ...
  creator_allowlist_placeholder:  { en: "youtube.com/@creator  or  dot-css-news.com",                                                                                                    es: "youtube.com/@creador  o  dot-css-news.com",                                                                                                                            pt: "youtube.com/@criador  ou  dot-css-news.com",                                                                                          de: "youtube.com/@creator  oder  dot-css-news.com" },
  creator_allowlist_add_btn:      { en: "+ Add creator",                                                                                                                                 es: "+ Añadir creador",                                                                                                                                                    pt: "+ Adicionar criador",                                                                                                                de: "+ Creator hinzufügen" },
  creator_allowlist_remove_btn:   { en: "Remove",                                                                                                                                        es: "Eliminar",                                                                                                                                                            pt: "Remover",                                                                                                                            de: "Entfernen" },
  creator_allowlist_err_empty:    { en: "Enter a domain or creator handle (e.g. youtube.com/@creator).",                                                                                 es: "Introduce un dominio o handle de creador (ej: youtube.com/@creador).",                                                                                                pt: "Insira um domínio ou identificador de criador (ex: youtube.com/@criador).",                                                          de: "Gib eine Domain oder einen Creator-Handle ein (z.B. youtube.com/@creator)." },
  creator_allowlist_err_duplicate:{ en: "That creator is already on your allowlist.",                                                                                                    es: "Ese creador ya está en tu lista.",                                                                                                                                    pt: "Esse criador já está na sua lista.",                                                                                                de: "Dieser Creator steht bereits auf deiner Liste." },
  ...
  creator_allowlist_err_max:      { en: "You've reached the 100-creator limit. Remove an entry to add a new one.",                                                                       es: "Has alcanzado el límite de 100 creadores. Elimina una entrada para añadir otra.",                                                                                     pt: "Você atingiu o limite de 100 criadores. Remova uma entrada para adicionar outra.",                                                   de: "Du hast das Limit von 100 Creatorn erreicht. Entferne einen Eintrag, um einen neuen hinzuzufügen." },
