...
export const TRANSLATIONS = {
  ...
  whatsNewRemoteRules:            { en: "New: you can enable weekly tracking-list updates in Settings. Off by default.",                                     es: "Novedad: puedes activar actualizaciones semanales de la lista de rastreo en Ajustes. Desactivado por defecto.", pt: "Novo: você pode ativar atualizações semanais da lista de rastreamento em Configurações. Desativado por padrão." /* FIXME: needs native speaker review */, de: "Neu: Wöchentliche Tracking-Listen-Aktualisierungen können in den Einstellungen aktiviert werden. Standardmäßig deaktiviert." /* FIXME: needs native speaker review */ },
