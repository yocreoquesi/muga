// ESM module mirroring `src/rules/caps-wrappers.json` (the Ed25519-signed
// wrapper-recipe artifact served at `caps.muga.app/wrappers.json`) for
// code-load convenience. The JSON is the signed source of truth — when
// editing wrappers, change both files together. A test enforces structural
