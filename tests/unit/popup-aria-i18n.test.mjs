...
// audit #1042's history disclosure aria-expanded resync test lived here.
// Removed under #1352: the "This session" ledger (and the stat-tile click
// that used to reveal it) moved to Settings' unified Activity ledger panel
// — #stat-urls-wrap is a plain, non-interactive stat tile now, with no
// aria-expanded/aria-controls state to resync.
