...
**429 tracking params + 12 prefix patterns** across 6 categories, on every site:
...
Domain-specific rules for **216 domains** preserve functional query params (search queries, pagination, filters) while removing the tracking.
...
- Remove 429 tracking params and 12 prefix patterns on every navigation (UTMs, fbclid, gclid, share tokens, click IDs, and more)
