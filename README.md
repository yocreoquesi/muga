...
[Clean a URL in your browser](https://muga.app/#demo-tool) · [Transparency report](https://rules.muga.app/transparency.html) · [Privacy policy](https://rules.muga.app/privacy-page.html) · [FAQ](docs/faq.md) · [Changelog](CHANGELOG.md) · [Contributing](CONTRIBUTING.md) · [ADRs](docs/adr/) · [Maintainer ops docs](docs/ops/README.md)
...
**362 tracking params + 12 prefix patterns** across 6 categories, on every site:
...
Domain-specific rules for **289 domains** preserve functional query params (search queries, pagination, filters) while removing the tracking.
...
- Remove 362 tracking params and 12 prefix patterns on every navigation (UTMs, fbclid, gclid, share tokens, click IDs, and more)
...
All of them toggle on and off at any time in Settings. Turning either "Follow shortener redirects" switch off stops resolution immediately.
