...
**395 tracking params + 12 prefix patterns** across 6 categories, on every site:
...
- Remove 395 tracking params and 12 prefix patterns on every navigation (UTMs, fbclid, gclid, share tokens, click IDs, and more)
